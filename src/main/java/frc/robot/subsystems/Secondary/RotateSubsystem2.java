...
public class RotateSubsystem2 extends SubsystemBase {
    ...
    private double kP = 0.005, kI = 0.0, kD = 0.0;
    private double kFF = 0.0005;
    private double kOutputMin = -1.0;
    private double kOutputMax = 1.0;
    private double kMaxRPM = 250;
    private double kMaxAccel = 250;

    

    public RotateSubsystem2() {
